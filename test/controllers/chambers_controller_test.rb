...
class ChambersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chamber" do
    assert_difference('Chamber.count') do
      post chambers_url, params: { chamber: { name: @chamber.name, target_humidity: @chamber.target_humidity, target_temp: @chamber.target_temp } }
    end
  ...
  test "should update chamber" do
    patch chamber_url(@chamber), params: { chamber: { name: @chamber.name, target_humidity: @chamber.target_humidity, target_temp: @chamber.target_temp } }
